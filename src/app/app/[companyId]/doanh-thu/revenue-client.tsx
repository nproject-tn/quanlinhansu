...
export function RevenueClient({
  ...
  return (
    <div className="space-y-6 pb-20">
      ...
      <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
        <div>
          <h1 className="text-2xl font-bold tracking-tight text-slate-900 dark:text-white flex items-center gap-2.5">
            <TrendingUp className="h-7 w-7 text-slate-900 dark:text-white" />
            Doanh thu & Quản lý Đơn hàng
          </h1>
        ...
        <div className="flex flex-wrap items-center gap-2.5">
          ...
          <Button
            ...
            className="h-9 gap-1.5 border-slate-300 dark:border-[#333333]"
          >
            <Download className="h-4 w-4" />
            <span>Xuất Excel</span>
          </Button>

          <Link href={`/app/${companyId}/ban-hang`}>
      ...
      <div className="flex flex-wrap items-center gap-2 bg-slate-100/80 dark:bg-[#252526] p-1.5 rounded-2xl w-fit border border-slate-200/60 dark:border-[#333333]">
        {[
